...
public class OneCoomitButchGenerator extends AbstactTableGenerator { 
	
	public OneCoomitButchGenerator(Connection connection, int totalRowCount) {		
		this(connection, totalRowCount, "Tab4");
	}
	
	public OneCoomitButchGenerator(Connection connection, int totalRowCount, String tableName) {
